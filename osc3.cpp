...
struct Osc3Widget : ModuleWidget  {
...

	{
        ...
        addParam(ParamWidget::create<SH_Button>(Vec(21 + .753, 105), module, Osc3::BUTTON4_PARAM, 0.0, 1.0, 0.0));
        addParam(ParamWidget::create<Up_Button>(Vec(47 + .753, 77.5), module, Osc3::BUTTON2_PARAM, 0.0, 1.0, 0.0));
        addParam(ParamWidget::create<Freq_Button>(Vec(75 + .753, 105), module, Osc3::BUTTON6_PARAM, 0.0, 1.0, 0.0));
        addParam(ParamWidget::create<Trig_Button>(Vec(7 + .753, 142), module, Osc3::BUTTON1_PARAM, 0.0, 1.0, 0.0));
        addParam(ParamWidget::create<Down_Button>(Vec(47 + .753, 131.5), module, Osc3::BUTTON5_PARAM, 0.0, 1.0, 0.0));
        addParam(ParamWidget::create<Loop_Button>(Vec(89 + .753, 142), module, Osc3::BUTTON3_PARAM, 0.0, 1.0, 0.0));
        ...
        addChild(ModuleLightWidget::create<MediumLight<WhiteLight>>(Vec(73.7 + .753, 268.5), module, Osc3::LED2_LIGHT));
        addChild(ModuleLightWidget::create<MediumLight<WhiteLight>>(Vec(35.8 + .753, 309.9), module, Osc3::LED3_LIGHT));
        addChild(ModuleLightWidget::create<MediumLight<WhiteLight>>(Vec(73.7 + .753, 309.9), module, Osc3::LED4_LIGHT));
