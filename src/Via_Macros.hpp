...
// #define DOWNSENSOR params[DOWN_PARAM].value
// #define LOOPSENSOR params[LOOP_PARAM].value
// #define TRIGSENSOR params[TRIG_PARAM].value
// #define FREQSENSOR params[FREQ_PARAM].value
// #define SHSENSOR params[SH_PARAM].value
// #define UPSENSOR params[UP_PARAM].value
