...
struct Sync3XLWidget : ModuleWidget {
	Sync3XLWidget(Sync3XL* module) {
		...
		addParam(createParamCentered<SifamBlack>(mm2px(Vec(43.315, 19.562)), module, Sync3XL::KNOB1_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(101.752,19.562)), module, Sync3XL::RES1_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(26.128,23.0)), module, Sync3XL::CV1AMT_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(77.69,26.437)), module, Sync3XL::FREQ1_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(125.815,26.437)), module, Sync3XL::MODE1_PARAM));
		addParam(createParamCentered<TransparentButton>(mm2px(Vec(53.628,40.188)), module, Sync3XL::BUTTON3_PARAM));
		addParam(createParamCentered<SifamBlack>(mm2px(Vec(43.315, 47.062)), module, Sync3XL::KNOB2_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(101.752,47.062)), module, Sync3XL::RES2_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(26.128,50.5)), module, Sync3XL::CV2AMT_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(77.69,53.938)), module, Sync3XL::FREQ2_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(125.815,53.938)), module, Sync3XL::MODE2_PARAM));
		...
		addParam(createParamCentered<SifamBlack>(mm2px(Vec(43.315, 74.562)), module, Sync3XL::KNOB3_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(101.752,74.562)), module, Sync3XL::RES3_PARAM));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(26.128,78.0)), module, Sync3XL::CV3AMT_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(77.69,81.438)), module, Sync3XL::FREQ3_PARAM));
		addParam(createParamCentered<SifamGrey>(mm2px(Vec(125.815,81.438)), module, Sync3XL::MODE3_PARAM));
		...
		addInput(createInputCentered<HexJack>(mm2px(Vec(8.94,26.437)), module, Sync3XL::CV1_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(63.94,26.57)), module, Sync3XL::FREQ1CV_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(8.94,53.938)), module, Sync3XL::CV2_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(63.94,53.839)), module, Sync3XL::FREQ2CV_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(8.94,81.438)), module, Sync3XL::CV3_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(63.94,81.339)), module, Sync3XL::FREQ3CV_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(101.752,108.938)), module, Sync3XL::RESCV_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(8.94, 108.938)), module, Sync3XL::MAIN_LOGIC_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(77.789,112.375)), module, Sync3XL::FREQCV_INPUT));
		addInput(createInputCentered<HexJack>(mm2px(Vec(125.815,112.375)), module, Sync3XL::MODECV_INPUT));

		addOutput(createOutputCentered<HexJack>(mm2px(Vec(143.002,16.125)), module, Sync3XL::LOGIC1_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(153.315,26.437)), module, Sync3XL::OUT1_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(143.002,43.625)), module, Sync3XL::LOGIC2_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(153.315,53.938)), module, Sync3XL::OUT2_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(143.002,71.125)), module, Sync3XL::LOGIC3_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(153.315,81.438)), module, Sync3XL::OUT3_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(143.002,98.625)), module, Sync3XL::LOGICMIX_OUTPUT));
		addOutput(createOutputCentered<HexJack>(mm2px(Vec(153.315,108.938)), module, Sync3XL::OUTMIX_OUTPUT));
